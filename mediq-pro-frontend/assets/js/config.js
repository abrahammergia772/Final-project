...
const CONFIG = {
  ...
  PERMISSIONS: {
    ...
    manager:    { departments: 1, staff: 1, reports: 1, finance: 1, ai: 1, messages: 1, settings: 1 },
    doctor:     { patients: 1, consultation: 1, prescriptions: 1, appointments: 1, referrals: 1, ai: 1, messages: 1, settings: 1 },
    nurse:      { vitals: 1, observations: 1, medications: 1, careplans: 1, messages: 1, settings: 1 },
    pharmacist: { prescriptions: 1, inventory: 1, suppliers: 1, ai: 1, messages: 1, settings: 1 },
    laboratory: { testrequests: 1, samples: 1, results: 1, ai: 1, messages: 1, settings: 1 },
    reception:  { registration: 1, appointments: 1, insurance: 1, queue: 1, messages: 1, settings: 1 },
    patient:    { appointments: 1, records: 1, results: 1, bills: 1, messages: 1, ai: 1, settings: 1 }
  }
};
